...
const translations = {
  en: {
    ...
    'quick.form.location.placeholder': 'e.g. Home, Office',
    ...
    'gateway.wifi.message': "Let's set up your WiFi network name and password.",
  ...
  es: {
    ...
    'quick.form.location.placeholder': 'ej. Casa, Oficina',
    ...
    'gateway.wifi.message': 'Configuremos el nombre y contraseña de tu red WiFi.',
  ...
  he: {
    ...
    'quick.form.location.placeholder': 'למשל: בית, משרד',
    ...
    'gateway.wifi.message': 'בוא נגדיר את שם רשת ה-WiFi והסיסמה שלך.',
